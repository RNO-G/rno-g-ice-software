...
INCLUDES=src/ice-config.h src/ice-buf.h src/ice-arena.h  src/ice-common.h 

.PHONY: all clean install uninstall 

OBJS:=$(addprefix $(BUILD_DIR)/, ice-config.o ice-buf.o ice-arena.o ice-common.o ice-version.o)
